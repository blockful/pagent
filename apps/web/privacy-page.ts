    ...
    return html`<a class="skip-link" href="#main">Skip to privacy notice</a>
      <div class="shell product-shell">
        <header class="topbar">
          ...
          ><a class="button quiet" href="/decks">Decks</a>
        </header>
        ...
        <main class="page prose" id="main">
          ...
          <section class="surface stack">
            ...
            <p>
              After a deck is at least half visible and you interact, Pagent may record the visit
              time, share link, presentation revision, viewed slides, active time, completion,
              device class, browser family, and coarse country. Background tabs and periods without
              activity for 60 seconds do not add active time.
            </p>
            <p>
          ...
          <section class="surface stack">
            ...
            <p>
              ...
              analytics, export records, and delete a deck; access and export changes are audited.
            </p>
            <p>
