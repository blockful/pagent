...
export function buildShowcaseSpec() {
  ...
  const components = [
    { id: 'root', component: 'Column', children: ['title', 'subtitle', 'card-btn', 'card-tf', 'card-cb', 'card-cp', 'card-tabs', 'card-dt', 'card-modal', 'card-typo', 'card-divider'] },
    { id: 'title', component: 'Text', text: 'Component Showcase', variant: 'h1' },
    { id: 'subtitle', component: 'Text', text: 'All basic catalog components styled with the shadcn design system.', variant: 'caption' },

    // -- Buttons --
    { id: 'card-btn', component: 'Card', child: 'btn-col' },
    { id: 'btn-col', component: 'Column', children: ['btn-title', 'btn-desc', 'btn-row1', 'btn-row2'] },
    { id: 'btn-title', component: 'Text', text: 'Button', variant: 'h3' },
    { id: 'btn-desc', component: 'Text', text: 'Three variants: primary, default (outline), and borderless (ghost).', variant: 'caption' },
    { id: 'btn-row1', component: 'Row', align: 'center', children: ['btn-primary', 'btn-default', 'btn-ghost'] },
    ...
    { id: 'btn-disabled', component: 'Button', child: 'btn-disabled-txt', variant: 'primary', isValid: false },
    ...
    { id: 'btn-icon-row', component: 'Row', align: 'center', children: ['btn-icon-ic', 'btn-icon-txt'] },
    ...
    { id: 'tf-col', component: 'Column', children: ['tf-title', 'tf-desc', 'tf-email', 'tf-pw', 'tf-num', 'tf-long', 'tf-err'] },
    { id: 'tf-title', component: 'Text', text: 'TextField', variant: 'h3' },
    { id: 'tf-desc', component: 'Text', text: 'Text, number, password, and long text (textarea) variants.', variant: 'caption' },
    ...
    { id: 'tf-err', component: 'TextField', label: 'With error', value: 'bad', variant: 'text', isValid: false, validationErrors: ['This field has an error.'] },

    // -- CheckBox & Slider --
    { id: 'card-cb', component: 'Card', child: 'cb-col' },
    { id: 'cb-col', component: 'Column', children: ['cb-title', 'cb-terms', 'cb-news', 'cb-invalid', 'cb-div', 'sl-bright', 'sl-opacity'] },
    ...
    { id: 'cb-invalid', component: 'CheckBox', label: 'Invalid checkbox', value: false, isValid: false, validationErrors: ['Required'] },
    ...
    { id: 'cp-col', component: 'Column', children: ['cp-title', 'cp-desc', 'cp-chips', 'cp-radios', 'cp-multi'] },
    { id: 'cp-title', component: 'Text', text: 'ChoicePicker', variant: 'h3' },
    { id: 'cp-desc', component: 'Text', text: 'Single and multi selection with chip and radio display styles.', variant: 'caption' },
    { id: 'cp-chips', component: 'ChoicePicker', label: 'Framework (chips)', variant: 'singleSelection', displayStyle: 'chips', options: [{ label: 'React', value: 'react' }, { label: 'Vue', value: 'vue' }, { label: 'Svelte', value: 'svelte' }, { label: 'Lit', value: 'lit' }], value: ['lit'] },
    { id: 'cp-radios', component: 'ChoicePicker', label: 'Notification preference (radios)', variant: 'singleSelection', displayStyle: 'default', options: [{ label: 'All', value: 'all' }, { label: 'Mentions only', value: 'mentions' }, { label: 'None', value: 'none' }], value: ['mentions'] },
    { id: 'cp-multi', component: 'ChoicePicker', label: 'Features (multi, chips)', variant: 'multipleSelection', displayStyle: 'chips', options: [{ label: 'Dark mode', value: 'dark' }, { label: 'Animations', value: 'anim' }, { label: 'Sounds', value: 'sound' }], value: ['dark', 'anim'] },
    ...
    { id: 'tabs-main', component: 'Tabs', tabs: [
    ...
    { id: 'tab-acct-desc', component: 'Text', text: 'Manage your account settings and preferences.', variant: 'body' },
    { id: 'tab-acct-name', component: 'TextField', label: 'Display name', value: 'Alice', variant: 'text' },
    ...
    { id: 'tab-pw-cur', component: 'TextField', label: 'Current password', value: '', variant: 'obscured' },
    { id: 'tab-pw-new', component: 'TextField', label: 'New password', value: '', variant: 'obscured' },
    ...
    { id: 'dt-date', component: 'DateTimeInput', label: 'Date only', enableDate: true, enableTime: false },
    { id: 'dt-time', component: 'DateTimeInput', label: 'Time only', enableDate: false, enableTime: true },
    { id: 'dt-both', component: 'DateTimeInput', label: 'Date & Time', enableDate: true, enableTime: true },
    ...
    { id: 'modal-desc', component: 'Text', text: 'Click the button below to open a dialog.', variant: 'caption' },
    ...
    { id: 'modal-content', component: 'Column', children: ['modal-dlg-title', 'modal-dlg-body', 'modal-dlg-field'] },
    { id: 'modal-dlg-title', component: 'Text', text: 'Dialog Title', variant: 'h3' },
    { id: 'modal-dlg-body', component: 'Text', text: 'This is an example dialog with some content inside it.', variant: 'body' },
    { id: 'modal-dlg-field', component: 'TextField', label: 'Your name', value: '', variant: 'text' },

    // -- Typography --
    { id: 'card-typo', component: 'Card', child: 'typo-col' },
    { id: 'typo-col', component: 'Column', children: ['typo-title', 'typo-h1', 'typo-h2', 'typo-h3', 'typo-h4', 'typo-h5', 'typo-body', 'typo-caption'] },
    ...
    { id: 'typo-body', component: 'Text', text: 'Body text renders as a paragraph. It should have comfortable line height and good readability across different screen sizes.', variant: 'body' },
    { id: 'typo-caption', component: 'Text', text: 'Caption text is smaller and muted — great for descriptions and help text.', variant: 'caption' },

    // -- Divider --
    { id: 'card-divider', component: 'Card', child: 'div-col' },
    { id: 'div-col', component: 'Column', children: ['div-title', 'div-above', 'div-line', 'div-below'] },
